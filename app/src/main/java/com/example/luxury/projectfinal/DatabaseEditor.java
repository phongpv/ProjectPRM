...
public class DatabaseEditor {
    ...
    public static List<Image> getImageData(DatabaseCreator databaseCreator, int categoryID) {
        ...
        while (cursor.moveToNext()) {
            ...
            Image image = new Image(id, cateID, image_url, hint, name, description);
            imageList.add(image);
        }
        return imageList;
    }
    ...
    public static void insertData(DatabaseCreator databaseCreator) {
        ...
        data_Image.put(c3, "Con vật rất dữ. Lông màu vàng chuyên đi ăn thịt những con vật khác.");
        ...
        data_Image.put(c3, "Con vật rất dữ. Lông màu vàng. Giống con hổ nhưng có bờm. Chuyên đi ăn thịt những con vật khác.");
        ...
        data_Image.put(c3, "Thuộc loài chim có thể bắt chước tiếng người.");
        ...
        data_Image.put(c3, "Con vật mà con người có thể ngồi lên cho nó cưỡi.");
        ...
        data_Image.put(c3, "Là con vật là loài chuột rất sợ. Dễ thương.");
        ...
        data_Image.put(c3, "Con vật này có đuôi rất to. Xòe rất đẹp.");
        ...
        data_Image.put(c3, "Giống con chó nhưng nó sống nơi hoang dã theo bầy đàn. Ban đêm thường kêu \"Hú Hú\".");
        ...
        data_Image.put(c3, "Là con vật hoang dã ở biển cả nhưng rất thân thiện với con người. Biết bơi. To và thường hay cứu người đuối nước ở biển.");
        ...
        data_Image.put(c3, "Con vật thuộc loài mèo nhưng to hơn nhiều lắm. sống ở rừng chạy rất nhanh.");
        ...
        data_Image.put(c3, "Con vật biết bay có 2 cánh rất to. Vòng đời của nó là từ trứng thành sâu thành nhộng thành ....");
        ...
        data_Image.put(c3, "Quả này màu tím. Trùm rất to. quả bằng đầu ngón tay. Có thể ngâm làm rượu");
        ...
        data_Image.put(c3, "Công chúa bạch tuyết đã ăn trái gì nên bị ngộ độc thực phẩm.");
        ...
        data_Image.put(c3, "Màu đỏ. Ăn ngon. Tên nghe rất tây.");
        ...
        data_Image.put(c3, "Lúc chín có màu Orange. Có thể làm nước ép. Siêu ngon");
        ...
        data_Image.put(c3, "Quả dài to bằng cổ tay. Số lượng nhiều là nải.");
        ...
        data_Image.put(c3, "Lúc chín có màu vàng. Hột to. ");
        ...
        data_Image.put(c3, "Cây tre non + cụt");
        ...
        data_Image.put(c3, "Miền nam gọi là Khóm");
        ...
        data_Image.put(c3, "Vỏ xanh ruột đỏ hột đen");
        ...
        data_Image.put(c3, "Vỏ đỏ ruột trắng hột đen hột bé tí ti");
        ...
        data_Image.put(c3, "Xe có 2 bánh. Có bàn đạp. học sinh tiểu học hay đi đến trường");
        ...
        data_Image.put(c3, "Xe có 2 bánh. Gán động cơ.");
        ...
        data_Image.put(c3, "Xe có 3 bánh. Phía trước có chỗ ngồi rất to.");
        ...
        data_Image.put(c3, "Xe rất to.Lấy xích làm bánh. Dùng trong chiến đấu.");
        ...
        data_Image.put(c3, "Xe ô tô to. Dùng để chở hàng");
        ...
        data_Image.put(c3, "Phương tiện bay được mà chỉ chở 2 người");
        ...
        data_Image.put(c3, "Phương tiện bay được chở rất nhiều hành khách và hàng hóa");
        ...
        data_Image.put(c3, "Xe đạp mà chạy bằng điện");
        ...
        data_Image.put(c3, "Dùng để quét nhà");
        ...
        data_Image.put(c3, "Dùng để đóng đinh");
        ...
        data_Image.put(c3, "Dùng để xách nước");
        ...
        data_Image.put(c3, "Dùng để đựng nước");
        ...
        data_Image.put(c3, "Dung để đựng đồ vật lên trên.");
        ...
        data_Image.put(c3, "Dùng để ngồi");
